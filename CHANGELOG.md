...
## Features
* Adds policy evaluation and override commands (`policy show`, `policy override`) for Sentinel policy workflows by @claude [#TBD](https://github.com/hashicorp/tfc-workflows-tooling/pull/TBD)
